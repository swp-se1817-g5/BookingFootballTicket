 ...
 * @author thuat
 */
@WebServlet(name="SeasonSummaryTicketServlet", urlPatterns={"/seasonSummaryTicket"})
public class SeasonSummaryTicketServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SeasonSummaryTicketServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SeasonSummaryTicketServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        String seasonSeatIdString = request.getParameter("seasonSeatIdd");
        ...
        int seatId;
        try {
            matchSeatId = Integer.parseInt(seasonSeatIdString);
            ...
            request.setAttribute("matchId", seasonId);
