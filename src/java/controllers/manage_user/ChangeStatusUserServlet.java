 ...
 * @author Vinh
 */
@WebServlet(name="ChangeStatusUserServlet", urlPatterns={"/changestatusUser"})
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(user.isStatus()){
                ...
                changed = UserDAO.getINSTANCE().ActiveUser(email);
            }
        } catch (NumberFormatException e) {
            throw new IllegalArgumentException("Invalid format", e);
        }
        response.sendRedirect("manageUser?changed=" + changed);
