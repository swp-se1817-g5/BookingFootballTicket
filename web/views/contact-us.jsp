<%-- 
    Document   : contact-us
    Created on : May 23, 2024, 12:08:11 AM
    Author     : thuat
--%>
...
<html class="no-js" lang="en-GB">
    <head>
        ...
        <link rel="canonical" href="https://www.footballticketpad.com/contact-us" />
        <link rel="alternate" hreflang="x-default" href="https://www.footballticketpad.com/contact-us" />
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <title>Buy or Sell Football Tickets | Contact Us - Football Ticket Pad</title>
        <meta name="description" content="Are you looking to buy or sell football tickets to some of the world's top matches? Football Ticket Pad can assist you - get in touch today.">
        ...
        <link rel="stylesheet" href="https://www.footballticketpad.com/assets/frontend/2018/css/pages/contact-page.css">
        ...
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/vendor/jquery-3.3.1.min.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/vendor/jquery-ui.min.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/vendor/jquery.inViewport.min.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/jquery-validator/jquery.validate.min.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/jquery-form.min.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/bootstrap-multiselect.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/hotel.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
        <script src="https://www.google.com/recaptcha/api.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/app.js?v=1.4" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
        <link rel="stylesheet" type="text/css" href="/assets/frontend/2018/css/cookieconsent.min.css" />
        <script src="/assets/frontend/2018/js/cookieconsent.min.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
        <script type="58c5f2e635b66afa0b8cf2da-text/javascript"> window.addEventListener("load", function() {window.cookieconsent.initialise({"palette": {"popup": {"background": "#000000B2"}, "button": {"background": "#133ABD"} }, "content": {"message": "This website uses cookies to ensure you get the best experience on our website.", "dismiss": "Got it!", "link": "Learn more", "href": "/privacy-policy"} }) }); </script>


    </head>
    <body class="28 pages pages-28 contact-us template-contact contact">
    ...
    <div class="container">
        <div class="content">
                ...
                <div class="inner">
                    <div class="left">
                        <div class="details">
                            ...
                            <script type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.footballticketpad.com"},{"@type":"ListItem","position":2,"name":"Contact Us","item":"https://www.footballticketpad.com/contact-us"}]}</script> </div>
                    </div>
                </div>
            </div>
            ...
            <div class="section">
                <div class="inner">
                    <form method="post" class="contact-form" action="https://www.footballticketpad.com/contact">
                        <div class="left">
                            <h2>Customer support</h2>
                            <p>Let us know how we can help and we'll get back to you as soon as possible</p>
                            <div class="input-container half">
                                <label>First name</label>
                                <input type="text" name="sender_firstname" required />
                            </div><div class="input-container half">
                                <label>Last name</label>
                                <input type="text" name="sender_lastname" required />
                            </div>
                            <div class="input-container half">
                            ...
                            <div class="input-container half">
                                <label>Order number (if available)</label>
                                <input type="text" name="sender_order_number" />
                            </div><div class="input-container half">
                                <label class="xs-m">Topic</label>
                            ...
                            <div class="actions">
                                <button type="submit" class="c2a_btn contact-submit" name="send_contact">Submit</button>
                            </div>
                        </div><div class="right">
                            <p>Our UK based team are always on hand to&nbsp;assist you when buying matchday football tickets from <a href="https://www.footballticketpad.com/about">Football Ticket Pad</a>. We also offer unrivalled customer support after you have made your ticket purchase.</p>
                            <p>Email <a href="mailto:info@footballticketpad.com">info@footballticketpad.com</a> or use the chat box that is in the bottom right corner of every page of our website. Also on this page, you can use the contact form to get in touch with us. Simply fill in your details and a member of our team will get straight back to you.</p>
                            <p>Our office hours are:</p>
                            <p>9am - 8pm (UK time) Monday - Friday<br/>
                                10am - 8pm Saturday<br/>
                                10am - 7pm Sunday</p>
                            <p>We aim to respond to emails and chat box messages immediately during our office hours. Outside of office hours we will do our best to get back to you as soon as possible.</p>
                            <p>And don&#39;t forget to take a look at our regularly updated <a href="https://www.footballticketpad.com/faq">Frequently Asked Questions</a> page.</p>
                            <p>You can also contact Football Ticket Pad on <a href="https://www.facebook.com/footballticketpad/">Facebook</a> and <a href="https://twitter.com/Ticket_Pad">Twitter</a>. Like and follow us to get updates on the latest promotional codes and be the first to read our popular news articles.</p>
                            <h3><strong>New GDPR Regulations:</strong></h3>
                            <p>If you would like to access the&nbsp;personal data which we have&nbsp;stored for you in our database&nbsp;or would like to opt out of us using your personal data please contact us.&nbsp;</p>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <style>
            @media (min-width: 1115px) and (max-width: 1216px) {
                .xs-m {
            ...
            @media (min-width: 601px) and (max-width: 618px) {
                .xs-m {
                    margin-bottom: 36px !important;
                }
            }
    ...
    <script type="58c5f2e635b66afa0b8cf2da-text/javascript">
        var ftpCore = ftpCore || {};
        ftpCore["rootURL"] = "https://www.footballticketpad.com";
    </script>
    <script async type="58c5f2e635b66afa0b8cf2da-text/javascript" src="//widget.trustpilot.com/bootstrap/v5/tp.widget.bootstrap.min.js"></script>

    <%@include file="footer.jsp" %>


    <script src="https://www.footballticketpad.com/assets/frontend/2018/js/slider.min.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
    <script src="https://www.footballticketpad.com/assets/frontend/2018/js/common_v1-1.js?v=1.4" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
    <script src="https://www.footballticketpad.com/assets/frontend/2018/js/app-mods.js?v=1.4" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>

    <script type="58c5f2e635b66afa0b8cf2da-application/javascript" async src="//static.klaviyo.com/onsite/js/klaviyo.js?company_id=TFyH8Y"></script>

    <script src="https://www.footballticketpad.com/assets/frontend/2018/js/underscore.min.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
    <script src="https://www.footballticketpad.com/assets/frontend/2018/js/jquery-validator/jquery.validate.min.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
    <script src="https://www.footballticketpad.com/assets/frontend/2018/js/jquery-form.min.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
    <script src="https://www.footballticketpad.com/assets/frontend/2018/js/vendor/intlTelInput.min.js" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-57128660-1" type="58c5f2e635b66afa0b8cf2da-text/javascript"></script>

    <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="58c5f2e635b66afa0b8cf2da-|49" defer></script></body>
</html>
