    ...
    <body>
        ...
        <div class="inner">
            <div class="text">
                ...
                <p> 3. Ngay sau khi nhận được thanh toán của khách hàng qua chuyển khoản, chúng tôi sẽ liên hệ với bạn để xác nhận thông tin và hỗ trợ giao vé theo thỏa thuận trên hợp đồng hoặc thỏa thuận trực tiếp với khách hàng. Nếu đã quá thời gian cam kết giao hàng mà khách hàng chưa nhận được sản phẩm có thể liên hệ tới số hottline: 0819215525 để được hỗ trợ.</p> 
                <p>&nbsp;</p>
            </div>
        </div>
