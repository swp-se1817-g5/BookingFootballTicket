...
<html class="no-js" lang="en-GB">
    <head>
        ...
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/vendor/jquery-3.3.1.min.js" type="277d7fe9745a504718d895ab-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/vendor/jquery-ui.min.js" type="277d7fe9745a504718d895ab-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/vendor/jquery.inViewport.min.js" type="277d7fe9745a504718d895ab-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/jquery-validator/jquery.validate.min.js" type="277d7fe9745a504718d895ab-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/jquery-form.min.js" type="277d7fe9745a504718d895ab-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/bootstrap-multiselect.js" type="277d7fe9745a504718d895ab-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/hotel.js" type="277d7fe9745a504718d895ab-text/javascript"></script>
        <script src="https://www.google.com/recaptcha/api.js" type="277d7fe9745a504718d895ab-text/javascript"></script>
        <script src="https://www.footballticketpad.com/assets/frontend/2018/js/app.js?v=1.4" type="277d7fe9745a504718d895ab-text/javascript"></script>
        ...
        <script src="/assets/frontend/2018/js/cookieconsent.min.js" type="277d7fe9745a504718d895ab-text/javascript"></script>
        <script type="277d7fe9745a504718d895ab-text/javascript"> window.addEventListener("load", function() {window.cookieconsent.initialise({"palette": {"popup": {"background": "#000000B2"}, "button": {"background": "#133ABD"} }, "content": {"message": "This website uses cookies to ensure you get the best experience on our website.", "dismiss": "Got it!", "link": "Learn more", "href": "/privacy-policy"} }) }); </script>
...
<body class="16 pages pages-16 home  home template-home">
    <div class="adwords-banner">Football Ticket Pad is the number one marketplace for football tickets. Prices are set by the sellers and may be above or below face value.</div>
    <div class="header-top-spacer for-below-m-view"></div>
    ...
    <header id="header" class="header-top" data-mod="sticky" data-anchor="body" data-className="sticky">
        <div class="header-inner">
            ...
            <script type="277d7fe9745a504718d895ab-text/javascript" charset="utf-8">
                (function ($) {
...
<div class="container">
    <div class="content">
        ...
        <style>
            .content-home-slider .content-inner form::before {
                /*content: 'search & book match tickets';*/
                content: attr(data-before-content)
            }
        </style>
        <div class="content-home-slider">
            <div class="content-inner">
                <div class="sub-heading">Popular Teams</div>
                <a href class="heading"><h1 class="team-name"> </h1></a>
                <form id="form-home" method="get" action="https://www.footballticketpad.com/ticket-search" data-before-content="Search and book match tickets">
                    <input type="text" name="search" class="forminput" placeholder="e.g. Champions League Final" id="search" /><button type="submit">
                        <div class="icon">
                            <div class="ftp-view"></div>
                        </div><div class="label">Search tickets</div>
                    </button>
                </form>
            </div>
            <div class="slides">
                <div class="item  active " data-team="Book Liverpool Tickets" data-url="https://www.footballticketpad.com/group/club/liverpool" style="background-image:url(https://www.footballticketpad.com/uploads/dropzone/6509ab49231c7_liverpool.jpg);"></div>
                <div class="item " data-team="Book Chelsea Tickets" data-url="https://www.footballticketpad.com/group/club/chelsea" style="background-image:url(https://www.footballticketpad.com/uploads/dropzone/6509ab6de8435_chelsea.jpeg);"></div>
                <div class="item " data-team="Book Arsenal Tickets" data-url="https://www.footballticketpad.com/group/club/arsenal-tickets" style="background-image:url(https://www.footballticketpad.com/uploads/dropzone/6509aad9a73ae_arsenal.jpeg.jpg);"></div>
                <div class="item " data-team="Book Manchester United Tickets" data-url="https://www.footballticketpad.com/group/club/manchester-united" style="background-image:url(https://www.footballticketpad.com/uploads/dropzone/6509ab6da9461_manutd.jpeg);"></div>
                <div class="item " data-team="Book Tottenham Tickets" data-url="https://www.footballticketpad.com/group/club/tottenham" style="background-image:url(https://www.footballticketpad.com/uploads/dropzone/6509ab6e120f0_tottenham.jpeg);"></div>
            </div>
            <div class="controls"></div>
        </div>

        <style>
            .item .block.match.featured .inner .badges:after{
                /* content: 'Featured';*/
            ...
            <div class="inner">
                ...
                <div class="grid top-games">
                    <div class="item large">
                        <div class="block match featured">
                            <div class="image" style="background-image:url(https://www.footballticketpad.com/uploads/wembley.jpg);"></div>
                            <div class="top">
                                ...
                                <div class="favourite event_10291" type="event" uid="10291">
                                    <button type="button" class="favourite-toggle ">
                                        ...
                                        <a href="/champions-league-tickets/champions-league-final-2024" class="inner">
                                            <div class="badges" data-after-content="Featured"> </div>
                                            <div class="teams">Champions League Final 2024</div>
                                            <div class="details">
                                                <div class="location">Wembley</div>
                                                <div class="date">01st June 2024</div>
                                                <div class="league">Champions League</div>
                                            </div>
                                            <div class="price-from">Tickets from <span class="price">&pound;1,665.00 </span></div>
                                            <div class="book">
                                            </div>
                                        </a>
                                </div>
                                                                                                                                                                                            ...
                                                                                                                                                                                            <div class="block team league">
                                                                                                                                                                                                <div class="favourite league_446" type="league" uid="446">
                                                                                                                                                                                                    <button type="button" class="favourite-toggle ">
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <div class="badge" style="background-image: url(https://www.footballticketpad.com/uploads/caraba.jpg);">
                                                                                                                                                                                                        <a href="/group/league/carabao-cup" class="image">
                                                                                                                                                                                                        <img src="https://www.footballticketpad.com/uploads/Carabao-Logo.png" alt="Carabao Cup" />
                                                                                                                                                                                                        </a>
                                                                                                                                                                                                        </div>
                                                                                                                                                                                                        <a href="https://www.footballticketpad.com/group/league/carabao-cup" class="inner">
                                                                                                                                                                                                        <div class="team-name">Carabao Cup</div>
                                                                                                                                                                                                        <div class="details">
                                                                                                                                                                                                        <div>0 Games listed</div>
                                                                                                                                                                                                        <div>8 Teams</div>
                                                                                                                                                                                                        <div><b>No tickets available</b></div>
                                                                                                                                                                                                ...
                                                                                                                                                                                                <div class="item">
                                                                                                                                                                                                    <div class="block team league">
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <div class="badge" style="background-image: url(https://www.footballticketpad.com/uploads/champ-le.jpg);">
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <a href="https://www.footballticketpad.com/group/league/champions-league-tickets" class="inner">
                                                                                                                                                                                                        <div class="team-name">Champions League</div>
                                                                                                                                                                                                        <div class="details">
                                                                                                                                                                                                        <div>1 Games listed</div>
                                                                                                                                                                                                        <div>32 Teams</div>
                                                                                                                                                                                                        <div>Tickets starting <b>from &pound;1,665.00 </b></div>
                                                                                                                                                                                                        </div>
                                                                                                                                                                                                        <div class="view">View fixtures</div>
                                                                                                                                                                                                        </a>
                                                                                                                                                                                                        </div>
