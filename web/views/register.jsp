                        ...
                        <form class="contact-bx" action="register" method="post">
                            <div class="row placeani">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="d-flex">
                                        <a class="btn flex-fill m-r5 facebook" href="https://www.facebook.com/v20.0/dialog/oauth?client_id=1145975029810907&redirect_uri=http://localhost:8080/BookingFootballTicket/loginFB"><i class="fa fa-facebook"></i>Facebook</a>
