...
INSERT INTO News (userId, title, content, createdBy, updatedBy,status,isDeleted)
VALUES (1, 'Exciting Match Ahead!', 'Dont miss the upcoming match between Manchester United and Real Madrid!', 'System', 'System','status',0),
       (2, 'Latest Transfer News', 'FC Barcelona signs a promising young talent. Read more here!', 'System', 'System','status',0),
	   (2, 'Latest Transfer News', 'FC Barcelona signs a promising young talent. Read more here!', 'System', 'System','status',0);
